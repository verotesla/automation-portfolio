...
Cuando un usuario escribe al bot, el mensaje se guarda en Sheets (con fecha legible, usuario, contenido e ID de chat) y el bot responde con un mensaje adecuado según detecte saludos, consultas de precio, horario, soporte o ubicación.
